    ...
    return (
        <SignUpStyle>
            <form onSubmit={e=>submitHandler(e)}>
                ...
                <div className="name">
                    <input onChange={(e)=>inputHandler(e)} type="text" placeholder="First Name" id="name" name="firstname" />
                </div>
                <div className="name">
                    <input onChange={(e)=>inputHandler(e)} type="text" placeholder="last name" id="name" name="lastname" />
                </div>
                <div className="email">
